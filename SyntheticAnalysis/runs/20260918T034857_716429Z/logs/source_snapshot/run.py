...
import os
os.environ.setdefault('OMP_NUM_THREADS','2');os.environ.setdefault('OPENBLAS_NUM_THREADS','2');os.environ.setdefault('NUMBA_NUM_THREADS','2')
...
def main():
    ...
    try:
        ...
        if args.phase in ['train','evaluate','plot']:
            ...
            all_figures(run);write_report(run)
